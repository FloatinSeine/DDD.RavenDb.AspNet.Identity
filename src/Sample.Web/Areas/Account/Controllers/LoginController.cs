...
using Sample.Web.Areas.Account.Models.Login;
...
namespace Sample.Web.Areas.Account.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "Login", new { ReturnUrl = returnUrl, area = "Account" }));
        }
